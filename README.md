...
A production-oriented lakehouse reference that ingests retail data, applies bronze/silver/gold transformations, and exposes curated models for analytics.

## Architecture

`	ext
Sources -> ADLS Bronze -> Spark Silver -> SQL Gold -> Power BI
`

## Technology stack

Azure Synapse, ADLS Gen2, PySpark, SQL, Power BI
